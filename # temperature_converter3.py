...
# This creates the title of the program and centers it
title = ttk.Label(main_frame, text="Temperature Converter", 
                     font = font_style)
...
fahrenheit_btn = ttk.Button(btn_frame, text="Fahrenheit", 
                     command=convert_to_fahrenheit, width=12)
fahrenheit_btn.pack(side=tk.LEFT, padx=10)

# This creates the Celsius button
celsius_btn = ttk.Button(btn_frame, text="Celsius", 
                     command=convert_to_celsius, width=12)
celsius_btn.pack(side=tk.LEFT, padx=10)
